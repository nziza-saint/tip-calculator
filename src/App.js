...
export default function App() {
  ...
  return (
    <>
      <div className="flex place-content-center mt-14 md:mt-24 mb-10 md:mb-14">
      ...
      <div className="flex place-content-center">
        <form className="md:w-2/3 mt-0 border bg-white rounded-t-2xl md:rounded-xl p-6 w-full">
          <div className=" grid md:grid-cols-2 gap-x-9">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={bill}
                  onChange={handleBill}
                  className="w-full h-11 p-1 pr-4 bg-[#f3f8fb] text-right font-bold text-2xl text-[#00474b] block border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#9fe8df]"
                  placeholder="0"
                />
              </div>

              <p className="mt-8 mb-1">Select Tip %</p>
              <div className="buttons">
                <button onClick={handleButton} value={5}>
                  5%
                </button>
                <button onClick={handleButton} value={10}>
                  10%
                </button>
                <button onClick={handleButton} value={15}>
                  15%
                </button>
                <button onClick={handleButton} value={25}>
                  25%
                </button>
                <button onClick={handleButton} value={50}>
                  50%
                </button>
                <input
                  value={percent}
              ...
              <p className="mt-8 mb-1">Number of People</p>
              <div className="relative">
                <div className="absolute inset-y-0 left-3 pl-1 flex items-center pointer-events-none">
                  <span className="sm:text-sm">
                    <svg
            ...
            <div className="bg rounded-xl p-6">
              <div className="flex justify-between items-center mb-9">
                ...
                <h2 className="text-5xl text-[#26c0ab]">${tip}</h2>
              </div>
              ...
              <div className="flex justify-between items-center mb-12">
                ...
                <h2 className="text-5xl text-[#26c0ab]">${total}</h2>
              </div>

              <button
                onSubmit={handleSubmit}
                className="reset-btn hover:bg-[#9fe8df]"
              >
                Reset
              </button>
            </div>
